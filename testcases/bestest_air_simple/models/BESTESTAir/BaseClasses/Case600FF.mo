...
model Case600FF
  ...
  Buildings.BoundaryConditions.WeatherData.ReaderTMY3 weaDat(filNam="/home/marius/Desktop/modelica/modelica-buildings/Buildings/Resources/weatherdata/USA_IL_Chicago-OHare.Intl.AP.725300_TMY3.mos",
      computeWetBulbTemperature=true)
    annotation (Placement(transformation(extent={{98,-96},{86,-84}})));
...
equation
  ...
  connect(weaDat.weaBus, roo.weaBus)  annotation (Line(
      points={{86,-90},{80.07,-90},{80.07,-1.575},{64.425,-1.575}},
      color={255,204,51},
      thickness=0.5,
      smooth=Smooth.None));
  ...
  connect(density.port, roo.ports[1])  annotation (Line(
      points={{-45,-76},{32,-76},{32,-23.7},{39.75,-23.7}},
      color={0,127,255},
      smooth=Smooth.None));
  ...
  connect(souInf.ports[1], roo.ports[2]) annotation (Line(points={{16,-40},{20,
          -40},{20,-23.1},{39.75,-23.1}}, color={0,127,255}));
  ...
  connect(lig.lat, sumLat.u[3]) annotation (Line(points={{-79,46},{-76,46},{-76,
          44},{-52,44},{-52,49.4}}, color={0,0,127}));
  ...
  connect(returnAir, roo.ports[4]) annotation (Line(points={{-100,-20},{-30,-20},
          {-30,-21.9},{39.75,-21.9}}, color={0,127,255}));
  connect(sinInf.ports[1], senCO2.port_b)
    annotation (Line(points={{2,-60},{8,-60}}, color={0,127,255}));
  connect(senCO2.port_a, roo.ports[5]) annotation (Line(points={{28,-60},{30,
          -60},{30,-21.3},{39.75,-21.3}},
                                     color={0,127,255}));
  ...
  connect(weaDat.weaBus, sinInf.weaBus) annotation (Line(
      points={{86,-90},{-20,-90},{-20,-59.88},{-10,-59.88}},
      color={255,204,51},
      thickness=0.5));
  connect(weaDat.weaBus, souInf.weaBus) annotation (Line(
      points={{86,-90},{-20,-90},{-20,-39.88},{4,-39.88}},
      color={255,204,51},
      thickness=0.5));
