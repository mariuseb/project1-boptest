...
model TestCase_Simple "Testcase model with ideal airflow"
  ...
  BESTESTAir.BaseClasses.SingleZoneRC singleZoneRC annotation (
    Placement(visible = true, transformation(origin = {62, 4}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
equation
  connect(con.TSup, fcu.TSup) annotation (
    Line(points={{-59,6},{-44,6},{-44,9.11111},{-21.4286,9.11111}},          color = {0, 0, 127}));
  connect(con.yFan, fcu.uFan) annotation (
    Line(points={{-59,0},{-44,0},{-44,2.88889},{-21.4286,2.88889}},          color = {0, 0, 127}));
  connect(fcu.supplyAir, singleZoneRC.supplyAir) annotation (
    Line(points={{0,13.7778},{46,13.7778},{46,6},{52,6}},color = {0, 127, 255}, pattern = LinePattern.Solid));
  connect(fcu.returnAir, singleZoneRC.returnAir) annotation (
    Line(points={{0,-6.44444},{14,-6.44444},{14,2},{52,2}},
                                                         color = {0, 127, 255}, pattern = LinePattern.Solid));
  connect(singleZoneRC.y, con.TZon) annotation (
    Line(points={{72.4,10.6},{90,10.6},{90,-34},{-98,-34},{-98,0},{-82,0}},        color = {0, 0, 127}, pattern = LinePattern.Solid));
