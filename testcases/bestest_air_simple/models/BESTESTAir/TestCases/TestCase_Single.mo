...
model TestCase_Single "Testcase model with ideal airflow"
  ...
  BaseClasses.SingleZone singleZone
...
equation
  ...
  connect(singleZone.supplyAir, fcu.supplyAir) annotation (Line(points={{46,6},
          {36,6},{36,4},{22,4},{22,13.7778},{0,13.7778}}, color={0,127,255}));
  connect(singleZone.returnAir, fcu.returnAir) annotation (Line(points={{46,2},
          {42,2},{42,-2},{0,-2},{0,-6.44444}}, color={0,127,255}));
  connect(singleZone.y, con.TZon) annotation (Line(points={{66.4,10.6},{80,10.6},
          {80,-56},{-94,-56},{-94,0},{-82,0}}, color={0,0,127}));
