...
model TestCase_SingleFour "Testcase model with ideal airflow"
  ...
  BaseClasses.SingleZone4RC singleZone4RC
...
equation
  ...
  connect(fcu.supplyAir, singleZone4RC.supplyAir) annotation (Line(points={{0,
          13.7778},{8,13.7778},{8,12},{20,12},{20,4},{38,4}}, color={0,127,255}));
  connect(fcu.returnAir, singleZone4RC.returnAir) annotation (Line(points={{0,
          -6.44444},{22,-6.44444},{22,0},{38,0}}, color={0,127,255}));
  connect(singleZone4RC.TAir1, con.TZon) annotation (Line(points={{60.8,10.8},{
          82,10.8},{82,-32},{-88,-32},{-88,0},{-82,0}}, color={0,0,127}));
