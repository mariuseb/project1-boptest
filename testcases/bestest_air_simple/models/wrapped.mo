model wrapped "Wrapped model"
	...
	Modelica.Blocks.Interfaces.RealOutput con_heaPI_reaE_y(unit="1") = mod.con.heaPI.reaE.y "";
	Modelica.Blocks.Interfaces.RealOutput zon_reaTEnv_y(unit="K") = mod.zon.reaTEnv.y "";
