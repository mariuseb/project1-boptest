...
model TestCase_2R2C "Testcase model with ideal airflow"
  ...
  BaseClasses.SingleZone2R2C zon
...
equation
  ...
  connect(fcu.supplyAir, zon.supplyAir) annotation (Line(points={{0,13.7778},{2,
          13.7778},{2,16},{22,16},{22,0},{32,0}}, color={0,127,255}));
  connect(fcu.returnAir, zon.returnAir) annotation (Line(points={{0,-6.44444},{
          4,-6.44444},{4,-4},{32,-4}}, color={0,127,255}));
  connect(zon.y, con.TZon) annotation (Line(points={{52.4,4.6},{86,4.6},{86,-42},
