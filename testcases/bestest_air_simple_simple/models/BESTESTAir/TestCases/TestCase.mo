...
model TestCase "Testcase model with ideal airflow"
  extends Modelica.Icons.Example;
  BaseClasses.Case900FF zon(mAir_flow_nominal=0.55)
    annotation (Placement(transformation(extent={{34,-10},{54,10}})));

  BaseClasses.FanCoilUnit fcu
    annotation (Placement(transformation(extent={{-24,-6},{4,30}})));
...
equation
  connect(con.yHeaVal, fcu.uHeaVal) annotation (Line(points={{-67,8},{-42,8},{
          -42,12},{-26,12}}, color={0,0,127}));
  connect(con.yFan, fcu.uFan) annotation (Line(points={{-67,4},{-54,4},{-54,6},
          {-36,6},{-36,2},{-26,2}}, color={0,0,127}));
  connect(con.yFanSta, fcu.uFanSta) annotation (Line(points={{-67,0},{-52,0},{
          -52,-4},{-26,-4}}, color={255,0,255}));
  connect(fcu.supplyAir, zon.supplyAir) annotation (Line(points={{4,22},{12,22},
          {12,28},{20,28},{20,2},{34,2}}, color={0,127,255}));
  connect(fcu.returnAir, zon.returnAir) annotation (Line(points={{4,-4},{10,-4},
          {10,-2},{34,-2}}, color={0,127,255}));
  connect(zon.TRooAir, con.TZon) annotation (Line(points={{61,0},{66,0},{66,2},
          {88,2},{88,-38},{-116,-38},{-116,4},{-90,4}}, color={0,0,127}));
  connect(con.yCooVal, gain.u) annotation (Line(points={{-67,12},{-64,12},{-64,
          42},{-58,42}}, color={0,0,127}));
  connect(gain.y, fcu.uCooVal) annotation (Line(points={{-35,42},{-34,42},{-34,
          22},{-26,22}}, color={0,0,127}));
