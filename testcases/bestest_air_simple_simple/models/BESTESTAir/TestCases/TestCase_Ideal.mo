...
model TestCase_Ideal "Testcase model with ideal airflow"
  ...
  BESTESTAir.BaseClasses.Case900FF zon(mAir_flow_nominal=0.55)
    annotation (Placement(visible = true, transformation(origin = {0, 0}, extent = {{34, -10}, {54, 10}}, rotation = 0)));

  BESTESTAir.BaseClasses.Thermostat_T con "Thermostat controller"
    annotation (Placement(visible = true, transformation(origin = {0, 0}, extent = {{-80, -10}, {-60, 10}}, rotation = 0)));
