model wrapped "Wrapped model"
	...
	Modelica.Blocks.Interfaces.RealOutput reaValRad_y(unit="1") = mod.reaValRad.y "";
	...
	Modelica.Blocks.Interfaces.RealOutput reaTRadOut_y(unit="K") = mod.reaTRadOut.y "";
	Modelica.Blocks.Interfaces.RealOutput weaSta_reaWeaSolTim_y(unit="s") = mod.weaSta.reaWeaSolTim.y "Solar time";
	Modelica.Blocks.Interfaces.RealOutput reaPRad_y(unit="W") = mod.reaPRad.y "";
	...
	Modelica.Blocks.Interfaces.RealOutput reaRadFlo_y(unit="kg/s") = mod.reaRadFlo.y "";
	Modelica.Blocks.Interfaces.RealOutput reaValFlo_y(unit="kg/s") = mod.reaValFlo.y "";
	...
	Modelica.Blocks.Interfaces.RealOutput reaTRadIn_y(unit="K") = mod.reaTRadIn.y "";
