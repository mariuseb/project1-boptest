...
model BuildingControl
  ...
  Buildings.Utilities.IO.SignalExchange.Overwrite oveTSupSet(description=
    ...
    annotation (Placement(visible = true, transformation(origin = {-38, -14}, extent = {{12, -12}, {-12, 12}}, rotation = 0)));
  ...
  Buildings.Utilities.IO.SignalExchange.Read reaTCoiRet(
    ...
    "Read heating coil return water temperature" annotation (Placement(
        visible = true, transformation(origin = {-107, -39}, extent = {{13, 13}, {-13, -13}}, rotation = 180)));
  ...
  Buildings.Utilities.IO.SignalExchange.Overwrite oveValCoi(u(
    ...
    annotation (Placement(visible = true, transformation(origin = {-92, -12}, extent = {{10, -10}, {-10, 10}}, rotation = 0)));
equation
  ...
  connect(veAirSp.y, oveTSupSet.u)
    annotation (Line(points={{-20.8,-8},{-22.9,-8},{-22.9,-14},{-23.6,-14}},    color={0,0,127}));
  ...
  connect(senTemCoiRet.T, reaTCoiRet.u)
    annotation (Line(points={{-141,-32},{-131,-32},{-131,-39},{-122.6,-39}},    color={0,0,127}));
  ...
  connect(conPIDcoil.y, oveValCoi.u)
    annotation (Line(points={{-76.8,-8},{-78.8, -8}, {-78.8, -12}, {-80, -12}}, color={0,0,127}));
  connect(oveTSupSet.y, conPIDcoil.u_s)
    annotation (Line(points={{-51.2,-14},{-48.7,-14},{-48.7,-8},{-58.4,-8}},    color={0,0,127}));
  connect(oveValCoi.y, valCoil.y)
    annotation (Line(points={{-103, -12}, {-104.3, -12}, {-104.3, -8},{-114,-8}}, color={0,0,127}));
