model wrapped "Wrapped model"
	...
	Modelica.Blocks.Interfaces.RealOutput reaCO2Gai_y(unit="None") = mod.reaCO2Gai.y "Zone CO2 gain";
	Modelica.Blocks.Interfaces.RealOutput reaTZon_y(unit="K") = mod.reaTZon.y "Zone air temperature";
	Modelica.Blocks.Interfaces.RealOutput ahu_reaFloExtAir_y(unit="kg/s") = mod.ahu.reaFloExtAir.y "'AHU extract air volume flowrate";
	...
	Modelica.Blocks.Interfaces.RealOutput reaPVent_y(unit="W") = mod.reaPVent.y "Thermal power of AHU";
	...
	Modelica.Blocks.Interfaces.RealOutput reaPRad_y(unit="W") = mod.reaPRad.y "Thermal power of AHU";
