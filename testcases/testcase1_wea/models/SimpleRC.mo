...
model SimpleRC
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus annotation(
    Placement(visible = true, transformation(extent = {{-108, 16}, {-68, 56}}, rotation = 0), iconTransformation(extent = {{-258, 26}, {-238, 46}}, rotation = 0)));
...
equation
  ...
  connect(set.y, con.u_s) annotation(
    Line(points = {{-79, -30}, {-72, -30}}, color = {0, 0, 127}));
  connect(senTZone.T, TRooAir.u) annotation(
    Line(points = {{80, 0}, {90, 0}, {90, -50}, {82, -50}}, color = {0, 0, 127}));
  ...
  connect(preTOut.T, weaBus.TDryBul) annotation(
    Line(points = {{-42, 0}, {-68, 0}, {-68, 36}, {-88, 36}}, color = {0, 0, 127}));
